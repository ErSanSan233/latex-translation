...
\setCJKmainfont[
    ...
    ]{FandolSong-Regular}  % 破产宋 Regular
\setCJKsansfont[
    BoldFont={NotoSansCJKsc-Black}, % 思源黑黑
    ItalicFont={DingTalk-JinBuTi},% 钉钉进步体
    SlantedFont={FandolFang-Regular}, % 破产仿宋
    ]{NotoSansCJKsc-DemiLight} % 思源黑半轻
\setCJKmonofont[
    BoldFont={PingFangSC-Medium}, % 苹方中黑
    ItalicFont={HannotateSC-W7},% 手札体常规
    SlantedFont={FandolFang-Regular}, % 破产仿宋
    ]{PingFangSC-Light} % 苹方细
\setmonofont[
    BoldFont={Inconsolata-Bold},
    ItalicFont={LMMono10-Italic}, % Latin Modern Mono 10 Italic
    ]{Inconsolata-Light}
