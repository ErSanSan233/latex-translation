...
\def\bib{\textsc{Bib}\TeX }%bibtex logo
...
%代码清单
\newsavebox{\codelistnumber}
\newsavebox{\coderesult}

\newenvironment{codelist}[2][TODO代码清单序号]{%
    \setlength{\parindent}{0pt}%
    \sbox{\codelistnumber}{%
        \colorbox{black}{\color{white}\textbf{#1}}%
    }%
    \sbox{\coderesult}{%
        \begin{minipage}{\linewidth - 21pt}%
