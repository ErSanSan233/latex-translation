...
\newenvironment{ltxexempleenv}{%
  \begin{list}{}{%
      ...
      \checkoddpage%
      \ifcpoddpage% si la page est impaire on fait d�border "un peu" le code et "bcp" l'exemple
        \setlength{\leftmargin}{-\ltxexmargintdeborde}%
        \setlength{\rightmargin}{-\ltxexmargextdeborde}
      \else% si la page est paire, on fait d�border "bcp" le code "un peu l'exemple"
        \setlength{\leftmargin}{-\ltxexmargextdeborde}%
        \setlength{\rightmargin}{-\ltxexmargintdeborde}
      \fi
